...
* Includes a [multi-stage `Dockerfile`](https://github.com/olliefr/apps/blob/main/Dockerfile.multistage), which actually is a good example of how to build Go binaries _for production releases_.
...
There is a more advanced example in [olliefr/apps-roach](https://github.com/olliefr/apps-roach) using [CockroachDB](https://github.com/cockroachdb/cockroach).
